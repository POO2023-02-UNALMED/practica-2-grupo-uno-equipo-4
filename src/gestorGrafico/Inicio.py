...
class Inicio:
    def __init__(self, root:Root):
        ...
        self.imagenes.config(image=imagen)#corregir image
        self.imagenes.image = imagen #corregir image
    ...
    def cambiarImagen(self, event):
        ...
        self.imagenes.config(image=newImage) # corregir a new Image
        self.imagenes.image = newImage #corregir a new image
        self.imagenes.pack(side="top")
